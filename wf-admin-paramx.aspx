<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf-admin-paramx.aspx.cs" Inherits="ServiceDesk3d.wf_admin_paramx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">	
        ...
        function showRemovePrompt(sender, args) {
            var answer = confirm("Are you sure you want to remove this record?");
            if (answer) {
                sender.click();
            }
            else args.set_cancel(true);
            ...
            <telerik:RadGrid ID="GridView1" runat="server" Visible="true" AllowSorting="true" OnSortCommand="GridView1_SortCommand" AutoGenerateColumns="false">
                ...
                <MasterTableView Font-Size="9" AlternatingItemStyle-BackColor="#eeeeee" ItemStyle-Height="13px" AlternatingItemStyle-Height="13px" HeaderStyle-Height="14px">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="fKey" HeaderText="" Visible="false"></telerik:GridBoundColumn>
                    </Columns>
                </MasterTableView>
            </telerik:RadGrid>
        </telerik:RadPageView>
