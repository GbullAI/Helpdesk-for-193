<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="ServiceDesk3d.ForgotPassword" %>
<!DOCTYPE html>
           ...
           <telerik:LayoutRow >
            ...
            <telerik:LayoutRow style="border:1px solid white; border-radius:5px; background-color:lavender; width:600px; margin-left:300px;">                               
                <Columns>
                    ...
                    <telerik:LayoutColumn>
                        <telerik:RadTextBox runat="server" ID="txtEmailID" EmptyMessage="Email ID" Width="200px"></telerik:RadTextBox>
                    </telerik:LayoutColumn>
                    ...
                    <telerik:LayoutColumn><br /></telerik:LayoutColumn> 
                    <telerik:LayoutColumn>
                        <telerik:RadButton runat="server" ID="btnSendEmail" Width="200px" OnClick="btnSendEmail_Click" Text="Send Email" ></telerik:RadButton>
                        <br /><br />
