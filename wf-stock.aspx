<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf-stock.aspx.cs" Inherits="ServiceDesk3d.wf_stock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td hidden="hidden">Asset Owner</td>
            <td hidden="hidden">:</td>
            <td hidden="hidden">
        ...
        <tr runat="server" id="rowSite2">
            ...
            <td>:</td>
            <td>
                <telerik:RadTextBox ID="txtPICEmail" runat="server" InputType="Email" Width="250px"></telerik:RadTextBox>
            </td>
        </tr>
        <%--<tr>
            <td>Site State</td>
        ...
        <tr runat="server" id="rowSite3">
            ...
            <td>
                ...
                <asp:RegularExpressionValidator Display="Dynamic" ID="RegularExpressionValidator2" runat="server" ErrorMessage="Numbers only" ControlToValidate="txtPICNo" ValidationExpression="^[0-9]\d"></asp:RegularExpressionValidator>	
            </td>	
            ...
            <td>	
                ...
                <asp:RegularExpressionValidator Display="Dynamic" ID="RegularExpressionValidator3" runat="server" ErrorMessage="Numbers only" ControlToValidate="txtSitePICMobileNo" ValidationExpression="^[0-9]\d"></asp:RegularExpressionValidator>
            </td>
        ...
        <tr hidden="hidden">
            ...
            <td>:</td>
            <td>
                <telerik:RadComboBox ID="drpAssetMaterial" runat="server" Width="250px"></telerik:RadComboBox>
            </td>
            <td>Plant</td>
             <td>:</td>
            <td>
                <telerik:RadTextBox ID="txtPlant" runat="server" Width="250px"></telerik:RadTextBox>
            </td>
        </tr>
         <tr hidden="hidden">
            <td>Mvmt</td>
            <td>:</td>
            <td>
                <telerik:RadTextBox ID="txtMvmt" runat="server" Width="250px"></telerik:RadTextBox>
            </td>
            <td>Material Doc</td>
             <td>:</td>
            <td>
                <telerik:RadTextBox ID="txtMaterialDoc" runat="server" Width="250px"></telerik:RadTextBox>
            </td>
        </tr>
        <tr hidden="hidden">
            <td>Post Date</td>
                    <td>:</td>
                    <td>
                        <telerik:RadDatePicker ID="txtPostDate" runat="server" Width="250px">
                            <DateInput runat="server" DisplayDateFormat="dd/MM/yy" DateFormat="dd/MM/yyyy"></DateInput>
                        </telerik:RadDatePicker>
                    </td>
        </tr>
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick" ScrollChildren="True" SelectedIndex="0">
        <Tabs>
            ...
            <telerik:RadTab TabIndex="7" runat="server" Text="Event Log">
                <TabTemplate>
                    Event Log
                </TabTemplate>
            </telerik:RadTab>
            ...
            <telerik:RadTab TabIndex="9" runat="server" Text="Asset Tracking">
             ...
             <telerik:RadTab TabIndex="10" runat="server" Text="Asset Maintainence" Visible="false">
                <TabTemplate>
                    Asset Maintainence
                </TabTemplate>
            </telerik:RadTab>
    ...
    <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="1">
        <telerik:RadPageView runat="server" TabIndex="0" Visible="false">
            <telerik:RadGrid ID="GridView1" runat="server" Visible="true" AutoGenerateColumns="false" ShowFooter="true" AllowPaging="true" AllowSorting="true" MasterTableView-PageSize="20" OnPageIndexChanged="GridView1_PageIndexChanged" OnPageSizeChanged="GridView1_PageSizeChanged" OnSortCommand="GridView1_SortCommand">
        ...
        <telerik:RadPageView runat="server" TabIndex="1">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <telerik:RadTextBox ID="txtAssetSupplierContact" runat="server" Width="250px" AutoPostBack="true" InputType="Number" onkeydown="javascript: return event.keyCode == 69 ? false : true"></telerik:RadTextBox>	
                        <asp:RegularExpressionValidator Display="Dynamic" ID="RegularExpressionValidator4" runat="server" ErrorMessage="Numbers only" ControlToValidate="txtAssetSupplierContact" ValidationExpression="^[0-9]\d"></asp:RegularExpressionValidator>	
                    </td>	
                ...
                <tr>
                    ...
                    <td hidden="hidden">System SN 1</td>
                    <td hidden="hidden">:</td>
                    <td hidden="hidden">
        ...
        <telerik:RadPageView runat="server" TabIndex="3">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                         <telerik:RadTextBox ID="txtVendorContactNo" runat="server" Width="250px" AutoPostBack="true" InputType="Number" onkeydown="javascript: return event.keyCode == 69 ? false : true"></telerik:RadTextBox>	
                        <asp:RegularExpressionValidator Display="Dynamic" ID="RegularExpressionValidator1" runat="server" ErrorMessage="Numbers only" ControlToValidate="txtVendorContactNo" ValidationExpression="^[0-9]\d"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <telerik:RadDatePicker ID="txtVendorContractStartx" runat="server" Width="250px">
                            <DateInput runat="server" DisplayDateFormat="dd/MM/yy" DateFormat="dd/MM/yyyy"></DateInput>
                        </telerik:RadDatePicker>
                    </td>
                    <td>Contact Email </td>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
                ...
                <br />
                <telerik:RadGrid ID="RadGridAssetUpload" runat="server" AllowSorting="true" Visible="true" ShowFooter="true" AutoGenerateColumns="false">
        ...
        <telerik:RadPageView runat="server" TabIndex="6">
            ...
            <telerik:RadGrid ID="GridView2" runat="server" Visible="true" AutoGenerateColumns="false" ShowFooter="true" AllowPaging="true" AllowSorting="true" MasterTableView-PageSize="20" OnPageIndexChanged="GridView2_PageIndexChanged" OnPageSizeChanged="GridView2_PageSizeChanged" OnSortCommand="GridView2_SortCommand">
                <ClientSettings EnableRowHoverStyle="true"></ClientSettings>
                <MasterTableView Font-Size="9" AlternatingItemStyle-BackColor="#eeeeee" ItemStyle-Height="13px" AlternatingItemStyle-Height="13px" HeaderStyle-Height="14px">
                    <Columns>
        ...
        <telerik:RadPageView runat="server" TabIndex="8">
            <telerik:RadGrid ID="radGridTickets" runat="server" Visible="true" AutoGenerateColumns="false" AllowPaging="true" MasterTableView-PageSize="10" ShowFooter="true">
                ...
                <MasterTableView Font-Size="9" AlternatingItemStyle-BackColor="#eeeeee" ItemStyle-Height="13px" AlternatingItemStyle-Height="13px" HeaderStyle-Height="14px">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="ID" UniqueName="LinkID" DataField="inclidentid" Aggregate="Count" FooterText="Total:  ">
                            <ItemTemplate>
        ...
        <telerik:RadPageView runat="server" TabIndex="9">
            <telerik:RadGrid ID="RadGridAssetTracking" runat="server" OnSortCommand="RadGridTracking_SortCommand" AllowSorting="true" ShowFooter="true" Visible="true" AutoGenerateColumns="false">
                <ClientSettings EnableRowHoverStyle="false"></ClientSettings>
                <MasterTableView Font-Size="8" AlternatingItemStyle-BackColor="#eeeeee" ItemStyle-Height="12px" AlternatingItemStyle-Height="12px" HeaderStyle-Height="14px">
                    <Columns>
        ...
        <telerik:RadPageView runat="server" TabIndex="10" Visible="false">
            <telerik:RadGrid ID="RadGridAssetMaintain" runat="server" OnSortCommand="RadGridAssetMaintain_SortCommand" AllowSorting="true" Visible="true" AutoGenerateColumns="false">
                <ClientSettings EnableRowHoverStyle="false"></ClientSettings>
                <MasterTableView Font-Size="8" AlternatingItemStyle-BackColor="#eeeeee" ItemStyle-Height="12px" AlternatingItemStyle-Height="12px" HeaderStyle-Height="14px">
                    <Columns>
                        <telerik:GridBoundColumn DataField="assetmaintaintrackingid" HeaderText="Maintainence Tracking ID"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="StatusID" HeaderText="Status Name"></telerik:GridBoundColumn>
        ...
        <tr>
            ...
            <asp:Label ID="lblUploadMessageInc" runat="server"></asp:Label>--%>
                <br />
                <telerik:RadGrid ID="RadGridAssetUpload1" runat="server" AllowSorting="true" Visible="true" ShowFooter="true" AutoGenerateColumns="false" OnItemCommand="RadGridAssetUpload1_ItemCommand">
