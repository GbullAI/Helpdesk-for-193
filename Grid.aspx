<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="Grid.aspx.cs" Inherits="ServiceDesk3d.Grid" %>
            ...
            <MasterTableView AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <telerik:GridDateTimeColumn DataField="BirthDate" HeaderText="BirthDate" SortExpression="BirthDate"
                        UniqueName="BirthDate" PickerType="DatePicker" DataFormatString="{0:dd/MM/yy}">
                        <HeaderStyle Width="150px" />
