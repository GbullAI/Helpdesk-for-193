<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf-stocktype.aspx.cs" Inherits="ServiceDesk3d.wf_stocktype" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
         ...
         function showRemovePrompt(sender, args) {
                var answer = confirm("Are you sure you want to remove this Stock type?");
                if (answer) {
                    sender.click();
                }
                else args.set_cancel(true);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            <td hidden="hidden">Stock Location</td>
            <td hidden="hidden">:</td>
            <td hidden="hidden">
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick" ScrollChildren="True" SelectedIndex="0">
        <Tabs>
            <telerik:RadTab TabIndex="0" runat="server" Text="Stock Type List" Selected="True">
                <TabTemplate>
                    Stock Type List
                </TabTemplate>
            </telerik:RadTab>
        ...
        <telerik:RadPageView runat="server" TabIndex="0">
            <telerik:RadGrid ID="GridView1" runat="server" Visible="true" AllowSorting="true" OnSortCommand="GridView1_SortCommand" AutoGenerateColumns="false" AllowPaging="true"  MasterTableView-PageSize="10" OnPageIndexChanged="GridView1_PageIndexChanged">
                ...
                <MasterTableView Font-Size="9" AlternatingItemStyle-BackColor="#eeeeee" ItemStyle-Height="13px" AlternatingItemStyle-Height="13px" HeaderStyle-Height="14px">
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Stock Type ID">
                            <ItemTemplate>
                        ...
                        <telerik:GridBoundColumn DataField="asset2ndcategorydesc" HeaderText="Stock Type Name"></telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="assetcategoryid" HeaderText="Stock Location"></telerik:GridBoundColumn>
