<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf-slatype.aspx.cs" Inherits="ServiceDesk3d.wf_slatype" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showRemovePrompt(sender, args) {
            var answer = confirm("Are you sure you want to remove this Severity Level Configuration?");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            <td>Sla Track Info</td>
            <td>:</td>
            <td>
                <telerik:RadTextBox ID="txtSlaTrackInfoID" runat="server" Width="250px" Enabled="false"></telerik:RadTextBox>
            </td>
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <telerik:RadComboBox ID="drpSLAType" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="drpSLACode_SelectedIndexChanged1"></telerik:RadComboBox>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr id="rowCategory" runat="server" visible="true">
            <td>Request Type</td>
            <td>:</td>
            <td>
        ...
        <tr id="rowUrgency" runat="server" visible="true">
            <td>Urgency</td>
            <td>:</td>
            <td>
                <telerik:RadComboBox ID="drpUrgency" runat="server" Width="250px" Filter="Contains" MarkFirstMatch="true" OnSelectedIndexChanged="drpUrgency_SelectedIndexChanged"></telerik:RadComboBox>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr id="rowImpact" runat="server" visible="true">
            <td>Impact</td>
            <td>:</td>
            <td>
        ...
        <tr id="rowPriority" runat="server" visible="true">
            <td>Priority</td>
            <td>:</td>
            <td>
                <telerik:RadComboBox ID="drpPriority" runat="server" Width="250px" Enabled="false"></telerik:RadComboBox>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr id="rowSubCategory" runat="server" visible="true">
        ...
        <tr hidden="hidden">
            ...
            <td hidden="hidden">:</td>
            <td hidden="hidden">
                <telerik:RadCheckBox ID="cbxNB" runat="server" Text="Yes"></telerik:RadCheckBox>
            </td>
        </tr>
        <tr hidden="hidden">
            <td>&nbsp;</td>
        ...
        <tr>
            <td style="border: 1px solid black">
                <table>
                    <tr>
                        <td style="font-weight: bold; font-size: 20px">External Severity Level</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <telerik:RadTextBox ID="txtIR" runat="server" Width="150px" InputType="Number" ShowButton="false" MinValue="0" onkeydown="javascript: return event.keyCode == 69 ? false : true"></telerik:RadTextBox>
                            Minutes
                        </td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <telerik:RadTextBox ID="txtOS" runat="server" Width="150px" InputType="Number" ShowButton="false" MinValue="0" onkeydown="javascript: return event.keyCode == 69 ? false : true"></telerik:RadTextBox>
                            Minutes
                        </td>
                    </tr>
                    <tr>
                        <td>Resolution Time &nbsp<img src="images/infoico64.png" alt="Select Resolution time" title="Resolution Time = (Level 1 + Response Time) + (Level 2 + Onsite Time) + (Level 3 + Onsite Time)" height="15" width="15" /></td>
                        <td>:</td>
                        <td>
                            <telerik:RadTextBox ID="txtRT" runat="server" Width="150px" InputType="Number" ShowButton="false" MinValue="0" onkeydown="javascript: return event.keyCode == 69 ? false : true"></telerik:RadTextBox>
                            Minutes
                        </td>
                    </tr>
                </table>
            ...
            <td style="border: 1px solid black">
                <table>
                    <tr>
                        <td style="font-weight: bold; font-size: 20px">Internal Severity Level</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <telerik:RadTextBox ID="txtLevel1" runat="server" Width="150px" InputType="Number" ShowButton="false" MinValue="0" onkeydown="javascript: return event.keyCode == 69 ? false : true"></telerik:RadTextBox>
                            Minutes
                        </td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <telerik:RadTextBox ID="txtLevel2" runat="server" Width="150px" InputType="Number" ShowButton="false" MinValue="0" onkeydown="javascript: return event.keyCode == 69 ? false : true"></telerik:RadTextBox>
                            Minutes
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <telerik:RadTextBox ID="txtLevel3" runat="server" Width="150px" InputType="Number" ShowButton="false" MinValue="0" onkeydown="javascript: return event.keyCode == 69 ? false : true"></telerik:RadTextBox>
                            Minutes
                        </td>
                    </tr>
                </table>
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick" ScrollChildren="True" SelectedIndex="0">
        <Tabs>
            <telerik:RadTab TabIndex="0" runat="server" Text="Severity Level Configuration List" Selected="True">
                <TabTemplate>
                    Severity Level Configuration List
                </TabTemplate>
            </telerik:RadTab>
    ...
    <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0">
        <telerik:RadPageView runat="server" TabIndex="0">
            <telerik:RadGrid ID="GridView1" runat="server" Visible="true" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" OnSortCommand="GridView1_SortCommand" MasterTableView-PageSize="10" OnPageIndexChanged="GridView1_PageIndexChanged">
                ...
                <MasterTableView Font-Size="9" AlternatingItemStyle-BackColor="#eeeeee" ItemStyle-Height="13px" AlternatingItemStyle-Height="13px" HeaderStyle-Height="14px">
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Severity Level Track Info">
                            <ItemTemplate>
                                <asp:LinkButton ID="useLinkButton" runat="server" CommandArgument='<%# Eval("slatrackinfoid") %>'
                                    CommandName="Show" OnCommand="useLinkButton_Command" Text='<%# Eval("slatrackinfoid") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridBoundColumn DataField="slaid" HeaderText="Severity Level Info"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="enquirytypeid" HeaderText="Request Type"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="enquirytypesubid" HeaderText="Sub Request Type"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="priorityid" HeaderText="Priority"></telerik:GridBoundColumn>
                        <%--<telerik:GridBoundColumn DataField="departmentid" HeaderText="Group"></telerik:GridBoundColumn>--%>
                        <telerik:GridBoundColumn DataField="coverageday" HeaderText="Coverage Day"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="coveragehour" HeaderText="Coverage Hour"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="InitialResponse" HeaderText="Initial Response(In Minutes)"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="onsitetime" HeaderText="Onsite Time(In Minutes)"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="resolutiontime" HeaderText="Resolution Time(In Minutes)"></telerik:GridBoundColumn>
                    </Columns>
        ...
        <telerik:RadPageView runat="server" TabIndex="1">
            ...
            <h3>
                <asp:Label runat="server" ID="lblDelete" Text="Delete Trail"></asp:Label></h3>
